 ...
 */
package com.alibaba.csp.sentinel.dashboard.dashboard.domain.cluster.state;
...
public class ClusterUniversalStatePairVO {
    ...
    private com.alibaba.csp.sentinel.dashboard.domain.cluster.state.ClusterUniversalStateVO state;

    public ClusterUniversalStatePairVO() {}

    public ClusterUniversalStatePairVO(String ip, Integer commandPort, com.alibaba.csp.sentinel.dashboard.domain.cluster.state.ClusterUniversalStateVO state) {
        this.ip = ip;
    ...
    public com.alibaba.csp.sentinel.dashboard.domain.cluster.state.ClusterUniversalStateVO getState() {
        return state;
    }
