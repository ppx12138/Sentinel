...
import com.alibaba.csp.sentinel.dashboard.domain.cluster.state.ClusterRequestLimitVO;
...
public class ClusterServerStateVO {
    ...
    private List<com.alibaba.csp.sentinel.dashboard.domain.cluster.state.ClusterRequestLimitVO> requestLimitData;
    ...
    public List<com.alibaba.csp.sentinel.dashboard.domain.cluster.state.ClusterRequestLimitVO> getRequestLimitData() {
