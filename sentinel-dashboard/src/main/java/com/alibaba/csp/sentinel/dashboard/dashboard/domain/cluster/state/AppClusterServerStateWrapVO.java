...
public class AppClusterServerStateWrapVO {
    ...
    private com.alibaba.csp.sentinel.dashboard.domain.cluster.state.ClusterServerStateVO state;
    ...
    public com.alibaba.csp.sentinel.dashboard.domain.cluster.state.ClusterServerStateVO getState() {
        return state;
    }
