...
public class AppClusterClientStateWrapVO {
    ...
    private com.alibaba.csp.sentinel.dashboard.domain.cluster.state.ClusterClientStateVO state;
    ...
    public com.alibaba.csp.sentinel.dashboard.domain.cluster.state.ClusterClientStateVO getState() {
        return state;
    }
