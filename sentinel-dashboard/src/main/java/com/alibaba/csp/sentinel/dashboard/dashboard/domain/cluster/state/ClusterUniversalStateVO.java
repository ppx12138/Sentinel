...
public class ClusterUniversalStateVO {
    ...
    private com.alibaba.csp.sentinel.dashboard.domain.cluster.state.ClusterClientStateVO client;
    private ClusterServerStateVO server;

    public com.alibaba.csp.sentinel.dashboard.domain.cluster.state.ClusterClientStateVO getClient() {
        return client;
    }
