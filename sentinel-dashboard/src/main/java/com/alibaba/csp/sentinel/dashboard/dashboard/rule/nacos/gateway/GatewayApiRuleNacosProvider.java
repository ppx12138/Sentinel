 ...
 */
package com.alibaba.csp.sentinel.dashboard.dashboard.rule.nacos.gateway;

import com.alibaba.csp.sentinel.adapter.gateway.common.api.ApiDefinition;
import com.alibaba.csp.sentinel.dashboard.datasource.entity.gateway.ApiDefinitionEntity;
import com.alibaba.csp.sentinel.dashboard.rule.DynamicRuleProvider;
import com.alibaba.csp.sentinel.dashboard.rule.nacos.NacosConfigUtil;
import com.alibaba.csp.sentinel.dashboard.rule.nacos.gateway.ApiDefinition2;
...
public class GatewayApiRuleNacosProvider implements DynamicRuleProvider<List<ApiDefinitionEntity>> {
    ...
    public List<ApiDefinitionEntity> getRules(String appName,String ip,Integer port) throws Exception {
        ...
        List<com.alibaba.csp.sentinel.dashboard.rule.nacos.gateway.ApiDefinition2> list = JSON.parseArray(rules, com.alibaba.csp.sentinel.dashboard.rule.nacos.gateway.ApiDefinition2.class);
    ...
    public static void main(String[] args) {
        ...
        List<com.alibaba.csp.sentinel.dashboard.rule.nacos.gateway.ApiDefinition2> list2 = JSON.parseArray(rules, ApiDefinition2.class);
