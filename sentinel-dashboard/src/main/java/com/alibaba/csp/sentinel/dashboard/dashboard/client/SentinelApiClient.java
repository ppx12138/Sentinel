 ...
 */
package com.alibaba.csp.sentinel.dashboard.dashboard.client;
                ...
                try {
                    ...
                    if (isSuccess(statusCode)) {
                        ...
                        if (isCommandNotFound(statusCode, value)) {
                            ...
                            future.completeExceptionally(new com.alibaba.csp.sentinel.dashboard.client.CommandFailedException(value));
                        }
                    }
