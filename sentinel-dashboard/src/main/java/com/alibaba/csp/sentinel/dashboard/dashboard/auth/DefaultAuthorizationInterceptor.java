 ...
 */
package com.alibaba.csp.sentinel.dashboard.dashboard.auth;
 ...
 * <p>
 * move from old {@link com.alibaba.csp.sentinel.dashboard.auth.AuthorizationInterceptor}.
 *
 * @author lkxiaolou
 * @author wxq
 * @since 1.7.1
...
public class DefaultAuthorizationInterceptor implements AuthorizationInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler)
        ...
        if (handler.getClass().isAssignableFrom(HandlerMethod.class)) {
            ...
            com.alibaba.csp.sentinel.dashboard.auth.AuthAction authAction = method.getAnnotation(AuthAction.class);
            if (authAction != null) {
