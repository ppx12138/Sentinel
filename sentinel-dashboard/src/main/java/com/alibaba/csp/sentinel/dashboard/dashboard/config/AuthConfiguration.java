 ...
 */
package com.alibaba.csp.sentinel.dashboard.dashboard.config;
...
@Configuration
@EnableConfigurationProperties(com.alibaba.csp.sentinel.dashboard.config.AuthProperties.class)
public class AuthConfiguration {

    private final com.alibaba.csp.sentinel.dashboard.config.AuthProperties authProperties;
